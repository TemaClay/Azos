...
SECRET_KEY = 'django-insecure-l#&3(q)d^yy@8+utq*%ow+qz&zoa^+*4-r4ya!i@zmaz4t@0tv'
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Куда собирать файлы
STATICFILES_DIRS = []  # Оставить пустым, если нет других источников
